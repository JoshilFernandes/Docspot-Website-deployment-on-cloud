...
<nav class="navvvvvvbar navvvvvvbar-default navvvvvvbar-top">
  ...
  <div class="navvvvvvbar-brand navvvvvvbar-center"><b><mark><i class="fas fa-hospital-user"></i> DocSpot <i class="fas fa-briefcase-medical"></i></mark></b>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li><a href="trainschedule.php"><img src="https://img.icons8.com/clouds/60/000000/planner.png"/>Doctor Schedule&nbsp</a></li>
     </ul>
